    ...
    <xs:group name="complexTypeModel">
        <xs:choice>
            ...
            <xs:sequence>
                <xs:annotation>
                    <xs:documentation>
                        This branch is short for &lt;complexContent> &lt;restriction
                        base="xs:anyType">
    ...
    <xs:complexType name="complexType" abstract="true">
        <xs:complexContent>
            <xs:extension base="xs:annotated">
                ...
                <xs:attribute name="defaultAttributesApply" type="xs:boolean" default="true"
                    use="optional" />
            </xs:extension>
        </xs:complexContent>
    </xs:complexType>
        ...
        <xs:complexType>
            <xs:complexContent>
                <xs:extension base="xs:annotated">
                    ...
                    <xs:attribute name="appliesToEmpty" type="xs:boolean" default="false"
                        use="optional" />
                    <xs:attribute name="mode" default="interleave" use="optional">
                        <xs:simpleType>
                            <xs:restriction base="xs:NMTOKEN">
